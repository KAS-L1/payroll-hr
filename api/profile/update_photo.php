...
if (isset($_POST['image'])) {
    ...
    if (file_put_contents($file_path, $image_data)) {
        ...
        // Check if the current picture is not the default one
        if (AUTH_USER['picture'] !== 'default.png') {
            // Set the path to the current picture
            $current_picture_path = $upload_dir . AUTH_USER['picture'];
        ...
        $UPDATE = $DB->UPDATE("users", $data,["user_id" => AUTH_USER_ID]);
