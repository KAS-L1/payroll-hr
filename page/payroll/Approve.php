<?php
    $payroll_process = $DB->SELECT_WHERE("payroll", "*", ["status" => 'Approved'], "ORDER BY updated_at DESC");
?>
...
<div class="page-content">
    ...
    <?php
        Breadcrumb([
            ...
            ['label' => 'Payroll Approved', 'url' => '/payroll/approve'],
        ]);
    ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><span class="badge bg-primary rounded-full">Approved</span></td>
                            </tr>
                        <?php } ?>
        ...
        <div class="panel h-full overflow-hidden border-0 p-0">
            <div class="min-h-[190px] bg-gradient-to-r from-[#4361ee] to-[#160f6b] p-6">
                <div class="flex items-center justify-between text-white">
                    <p class="text-xl">Total Net Released</p>
